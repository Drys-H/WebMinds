          ...
          <div className="absolute inset-0">
            <div className="mx-auto flex h-full max-w-7xl flex-col justify-between px-4 py-6">
              <div className="flex items-start justify-between gap-4">
                <Link
                    to="/recipes"
                    className="inline-flex items-center gap-2 rounded-xl bg-[var(--color-surface)] px-4 py-2 text-sm font-semibold text-[var(--color-text)] shadow-sm"
                >
                ...
                <div className="flex gap-3">
                  ...
                  <button
                      type="button"
                      onClick={handleShare}
                      className="grid h-11 w-11 place-items-center rounded-xl bg-[var(--color-surface)] text-[var(--color-text-muted)] shadow-sm"
                  >
        ...
        <section className="mx-auto max-w-7xl px-4 py-8">
          <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
            <div>
              ...
              <div className="mt-8 rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
                  ...
                  {steps.length > 0 ? (
                      steps.map((step, index) => (
                          <div key={index} className="flex gap-4">
                            ...
                            <p className="pt-1 text-[var(--color-text)]">{step}</p>
                          </div>
                      ))
                  ) : (
              ...
              <div className="mt-8 rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
                ...
                <div className="mt-6 rounded-3xl bg-[var(--color-background)] p-5 border border-[var(--color-border)]">
                  <h3 className="text-xl font-bold text-[var(--color-text)]">Leave a review</h3>
            ...
            <aside className="space-y-6">
              <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
                <h3 className="text-2xl font-bold text-[var(--color-text)]">Recipe by</h3>
              ...
              <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-sm">
                <h3 className="text-2xl font-bold text-[var(--color-text)]">Details</h3>
